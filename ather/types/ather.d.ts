...
export type HttpRequestFunction = (query: string, type: "GET" | "POST") => Promise<{
    data: unknown;
    status: "success" | "error";
}>;
...
export type { AtherOptions, User, Message, Channel, Guild, Embed, Attachment, AtherSocketResponse, AtherSocketRequest, AtherHttpOptions, Service, IAtherSocketClient };
